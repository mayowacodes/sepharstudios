...
import { d as db, c as user, m as mediaLibrary } from './drizzle-CW7hPjGG.js';
...
const GET = async ({ url, locals }) => {
  ...
  const items = await query.orderBy(desc(mediaLibrary.createdAt)).limit(limit).offset(offset);
  return json(items);
};

export { GET };
//# sourceMappingURL=_server.ts-BChJ-H1E.js.map
