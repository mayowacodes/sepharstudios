import { aF as BROWSER, q as setContext, aE as readable, az as derived$1, aG as get$2, o as getContext } from './ui-libs-Yf6h8PPk.js';
import { M as MAX_ITEMS_PER_PAGE, R as Role } from './index-DDpoV-rm.js';
...
function createBaseQuery(options, Observer, queryClient) {
  ...
  const defaultedOptionsStore = derived$1([optionsStore, isRestoring], ([$optionsStore, $isRestoring]) => {
  ...
  const result = derived$1(isRestoring, ($isRestoring, set) => {
    const unsubscribe = $isRestoring ? noop : observer.subscribe(notifyManager.batchCalls(set));
    observer.updateResult();
    return unsubscribe;
  });
  const { subscribe } = derived$1([result, defaultedOptionsStore], ([$result, $defaultedOptionsStore]) => {
...
//# sourceMappingURL=fxn-CDk8N5rM.js.map
