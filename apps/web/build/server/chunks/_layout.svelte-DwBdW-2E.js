import { x as attr_class, b as ensure_array_like, i as attr, c as clsx$1, q as escape_html, t as bind_props, f as derived, a6 as Scroll_area$1, s as spread_props, a7 as Scroll_area_viewport, a8 as Scroll_area_corner, a9 as Scroll_area_scrollbar$1, aa as Scroll_area_thumb, w as writable } from './index.js-CxPEndTa.js';
...
import { L as List_video, C as Clapperboard } from './list-video-BH3zJUXt.js';
import { C as Clock } from './clock-ai1c2oRA.js';
import { C as Coins } from './coins-HZ1N_e-W.js';
import { C as Crown } from './crown-J9gEBSih.js';
...
import { U as User$1 } from './user-DfNTMTjp.js';
...
import { S as Sheet, e as Sheet_trigger, a as Sheet_content, b as Sheet_header, c as Sheet_title, d as Sheet_description } from './sheet-CF_bCjvd.js';
import { D as Dropdown_menu, a as Dropdown_menu_trigger, b as Dropdown_menu_content, c as Dropdown_menu_label, d as Dropdown_menu_separator, e as Dropdown_menu_item } from './dropdown-menu-ZI0zkml5.js';
import { A as Avatar, a as Avatar_image, b as Avatar_fallback } from './avatar-DwYkzjOK.js';
import { S as StreakStcWidget } from './StreakStcWidget-DhXW7V8C.js';
...
function Logo($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<a${attr("href", isAuthenticated() ? "/browse" : "/")}${attr_class(clsx$1(cn("flex items-center space-x-2 transition-opacity hover:opacity-80", className)))}><img src="/logo-alone-sepharstudios-bgless.png" alt="Sephar Studios" class="h-8 w-auto object-contain"/> <!---->`);
	...
	$$renderer.component(($$renderer) => {
		...
		if (!isKidsPage()) {
			...
			for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
				...
				$$renderer.push(`<a${attr("href", href)}${attr_class(clsx$1(navLinkClass(href)))}>${escape_html(label)}</a>`);
			}
...
function Footer($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<footer${attr_class(clsx$1(cn("border-t bg-background", className)))}><div class="container py-8 md:py-12 mx-auto px-4"><div class="grid gap-8 md:grid-cols-2 lg:grid-cols-5 items-start"><div class="flex flex-col gap-4 text-left">`);
		Logo($$renderer, {});
...
//# sourceMappingURL=_layout.svelte-DwBdW-2E.js.map
