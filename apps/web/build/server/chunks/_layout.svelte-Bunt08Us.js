import { ai as attr_class, as as ensure_array_like, ah as attr, an as clsx$1, au as escape_html, al as bind_props, av as fallback, ap as derived, X as Scroll_area$1, aO as spread_props, $ as Scroll_area_viewport, Y as Scroll_area_corner, Z as Scroll_area_scrollbar$1, _ as Scroll_area_thumb, aY as writable } from './ui-libs-BjzLDLAh.js';
...
import { L as List_video, C as Clapperboard } from './list-video-0Mswicoi.js';
...
import { U as User$1 } from './user-DvE0JuLE.js';
import { X } from './x-CQt15sbx.js';
import { g as goto } from './client-Bo2aevGq.js';
import { p as page } from './state-D0xWVGEE.js';
import { c as cn } from './utils2-BaRxD-PE.js';
import { B as Button } from './button-DY9ayrhs.js';
import { S as Sheet, e as Sheet_trigger, a as Sheet_content, c as Sheet_header, d as Sheet_title, b as Sheet_description } from './sheet-IIx2I3vF.js';
import { D as Dropdown_menu, i as Dropdown_menu_trigger, a as Dropdown_menu_content, d as Dropdown_menu_label, e as Dropdown_menu_separator, c as Dropdown_menu_item } from './dropdown-menu-CfwP_AW7.js';
...
function Header($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (!isKidsPage()) {
			...
			if (isAuthenticated()) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<a href="/watchlist"${attr_class(clsx$1(navLinkClass("/watchlist")))}>My List</a>`);
			} else $$renderer.push("<!--[-1-->");
...
//# sourceMappingURL=_layout.svelte-Bunt08Us.js.map
