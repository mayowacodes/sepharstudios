...
import { d as Card_title, b as Card_description } from './card-DVq40lxr.js';
import { L as Loading_spinner } from './loading-spinner-Bdr1X3pO.js';
import { s as signIn } from './auth-client-Cjc1-W_A.js';
...
function Auth_card_header($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<div${attr_class(clsx$1(className))}><a href="/" class="flex items-center gap-2 self-center font-medium"><div class="flex flex-col">`);
		if (Card_title) {
			$$renderer.push("<!--[-->");
			Card_title($$renderer, {
				class: "text-xl",
...
//# sourceMappingURL=social-auth-form-CJqYXi26.js.map
