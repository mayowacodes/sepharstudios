import { s as spread_props, x as attr_class, v as stringify, i as attr, q as escape_html, af as onDestroy, k as head, b as ensure_array_like, f as derived, l as html } from './index.js-CxPEndTa.js';
...
import { s as sectionLabel, t as translateRole } from './role-labels-DXT9bSRm.js';
import './client-DsZfmj3l.js';
import { p as page } from './state-p7jw8P-1.js';
import { a as copilotContext } from './copilot-DF7wVO-j.js';
import { B as Button } from './button-DtPBvYl-.js';
import { V as VideoPlayer } from './VideoPlayer-DsjXHJuF.js';
...
//#region ../../node_modules/.bun/@lucide+svelte@1.24.0+5726b9c92ebd8575/node_modules/@lucide/svelte/dist/icons/flag.svelte
...
function ReportButton($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let { label, variant = "icon", class: klass = "" } = $$props;
		if (variant === "icon") {
			$$renderer.push("<!--[0-->");
...
function PPVPaywall($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let { contentTitle, priceCents} = $$props;
		let loading = false;
...
//# sourceMappingURL=_page.svelte-CJwgu2bS.js.map
