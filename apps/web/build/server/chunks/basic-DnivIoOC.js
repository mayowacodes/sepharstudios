import { D as i, B as elementStyles, L as resetStyles, F as i$1, T, g as ConnectorController, c as ApiController, O as OptionsController, l as CoreHelperUtil, m as EventsController, R as RouterController, h as ConnectorUtil, e as AssetUtil, f as ConnectionController, o as StorageUtil, j as ConstantsUtil, W as WalletUtil, C as ChainController, d as AssetController, p as ThemeController, n as SnackController, M as ModalController, k as ConstantsUtil$1, u as b, A, w as colorStyles } from './core-CNP2T1Uv.js';
import { n as n$1, c as customElement, o as o$1, r, U as UiHelperUtil, e as e$1, f, a as e$2 } from './index-CSG18HjE.js';
import { l as getDefaultExportFromCjs } from './config-BPBzrUzB.js';
...
let WuiAllWalletsImage = class WuiAllWalletsImage extends i$1 {
    ...
    render() {
        ...
        return T `${this.walletImages
            .slice(0, TOTAL_IMAGES)
            .map(({ src, walletName }) => T `
            <wui-wallet-image
              size="inherit"
              imageSrc=${src}
              name=${o$1(walletName)}
          ...
          `)}
      ${isPlaceholders
            ? [...Array(TOTAL_IMAGES - this.walletImages.length)].map(() => T ` <wui-wallet-image size="inherit" name=""></wui-wallet-image>`)
            : null}
      <wui-flex>
        <wui-icon-box
          size="xxs"
...
let WuiListWallet = class WuiListWallet extends i$1 {
    ...
    templateStatus() {
      ...
      ></wui-loading-spinner>`;
            ...
            return T `<wui-tag variant=${this.tagVariant}>${this.tagLabel}</wui-tag>`;
        }
        else if (this.icon) {
            return T `<wui-icon color="inherit" size="sm" name=${this.icon}></wui-icon>`;
        }
        return null;
    }
};
        ...
        return connectorTypeOrder.map(type => {
            switch (type) {
                case 'injected':
                    return T `
            ${multiChain.length
                        ? T `<w3m-connect-multi-chain-widget
                  tabIdx=${o$1(this.tabIdx)}
                ></w3m-connect-multi-chain-widget>`
                        : null}
            ${announced.length
                        ? T `<w3m-connect-announced-widget
                  tabIdx=${o$1(this.tabIdx)}
                ></w3m-connect-announced-widget>`
                        : null}
            ${injected.length
                        ? T `<w3m-connect-injected-widget
                  .connectors=${injected}
                  tabIdx=${o$1(this.tabIdx)}
          ...
          `;
                case 'walletConnect':
                    return T `<w3m-connect-walletconnect-widget
            tabIdx=${o$1(this.tabIdx)}
          ></w3m-connect-walletconnect-widget>`;
                case 'recent':
                    return T `<w3m-connect-recent-widget
            tabIdx=${o$1(this.tabIdx)}
          ></w3m-connect-recent-widget>`;
                case 'featured':
                    return T `<w3m-connect-featured-widget
            .wallets=${featured}
            tabIdx=${o$1(this.tabIdx)}
          ></w3m-connect-featured-widget>`;
                case 'custom':
                    return T `<w3m-connect-custom-widget
            tabIdx=${o$1(this.tabIdx)}
          ></w3m-connect-custom-widget>`;
                case 'external':
                    return T `<w3m-connect-external-widget
            tabIdx=${o$1(this.tabIdx)}
          ></w3m-connect-external-widget>`;
                case 'recommended':
                    return T `<w3m-connect-recommended-widget
            .wallets=${recommended}
            tabIdx=${o$1(this.tabIdx)}
...
let WuiTabs = class WuiTabs extends i$1 {
    ...
    iconTemplate(tab) {
        if (tab.icon) {
            return T `<wui-icon size="xs" color="inherit" name=${tab.icon}></wui-icon>`;
        }
        return null;
    }
    onTabClick(index) {
...
let W3mConnectingWcView = class W3mConnectingWcView extends i$1 {
    ...
    platformTemplate() {
        ...
        `;
            case 'qrcode':
                return T `<w3m-connecting-wc-qrcode></w3m-connecting-wc-qrcode>`;
            default:
...
let W3mConnectingWcBasicView = class W3mConnectingWcBasicView extends i$1 {
    ...
    render() {
      ...
      >
        ...
        return T `<wui-flex flexDirection="column" .padding=${['0', '0', 'l', '0']}>
 ...
 */const e=()=>new h;class h{}const o=new WeakMap,n=e$1(class extends f{render(i){return A}update(i,[s]){const e=s!==this.G;return e&&void 0!==this.G&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.G=s,this.ht=i.options?.host,this.rt(this.ct=i.element)),A}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.G){const i=this.ht??globalThis;let s=o.get(i);void 0===s&&(s=new WeakMap,o.set(i,s)),void 0!==s.get(this.G)&&this.G.call(this.ht,void 0),s.set(this.G,t),void 0!==t&&this.G.call(this.ht,t);}else this.G.value=t;}get lt(){return "function"==typeof this.G?o.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0);}reconnected(){this.rt(this.ct);}});
...
let W3mAllWalletsList = class W3mAllWalletsList extends i$1 {
    ...
    walletsTemplate() {
        ...
        return walletsWithInstalled.map(wallet => T `
...
let W3mAllWalletsSearch = class W3mAllWalletsSearch extends i$1 {
    ...
    render() {
        this.onSearch();
        return this.loading
            ? T `<wui-loading-spinner color="accent-100"></wui-loading-spinner>`
...
let W3mAllWalletsView = class W3mAllWalletsView extends i$1 {
    ...
    render() {
      ...
      ${isSearch || this.badge
            ? T `<w3m-all-wallets-search
            query=${this.search}
            badge=${o$1(this.badge)}
          ></w3m-all-wallets-search>`
            : T `<w3m-all-wallets-list badge=${o$1(this.badge)}></w3m-all-wallets-list>`}
    `;
    }
    onInputChange(event) {
...
let WuiListItem = class WuiListItem extends i$1 {
    ...
    visualTemplate() {
        if (this.variant === 'image' && this.imageSrc) {
            return T `<wui-image src=${this.imageSrc} alt=${this.alt ?? 'list item'}></wui-image>`;
        }
        if (this.iconVariant === 'square' && this.icon && this.variant === 'icon') {
            return T `<wui-icon name=${this.icon}></wui-icon>`;
        }
    ...
    chevronTemplate() {
        if (this.chevron) {
            return T `<wui-icon size="inherit" color="fg-200" name="chevronRight"></wui-icon>`;
        }
        return null;
    }
};
...
//# sourceMappingURL=basic-DnivIoOC.js.map
