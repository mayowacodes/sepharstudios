import { _ as __exportAll } from './rolldown-runtime-pTpnEGsq.js';
...
function getSideAxis(placement) {
  return yAxisSides.has(getSide$2(placement)) ? 'y' : 'x';
}
...
function getOppositeAxisPlacements(placement, flipAlignment, direction, rtl) {
  const alignment = getAlignment(placement);
  let list = getSideList(getSide$2(placement), direction === 'start', rtl);
  if (alignment) {
...
function computeCoordsFromPlacement(_ref, placement, rtl) {
  ...
  const side = getSide$2(placement);
...
const flip$1 = function (options) {
  ...
  return {
    ...
    async fn(state) {
      ...
      const isBasePlacement = getSide$2(initialPlacement) === initialPlacement;
...
const shift$1 = function (options) {
  ...
  return {
    ...
    async fn(state) {
      ...
      const overflow = await detectOverflow(state, detectOverflowOptions);
      const crossAxis = getSideAxis(getSide$2(placement));
  ...
  return {
    ...
    fn(state) {
      ...
      if (checkCrossAxis) {
        ...
        const isOriginSide = originSides.has(getSide$2(placement));
...
export { Scroll_area_viewport as $, Accordion as A, Menu_item as B, Command as C, DevalueError as D, Menu_separator as E, Menu_sub as F, Menu_sub_content as G, HOLE as H, Menu_sub_trigger as I, Menu_trigger as J, NEGATIVE_INFINITY as K, Label as L, MAX_ARRAY_INDEX as M, NAN as N, NEGATIVE_ZERO as O, POSITIVE_INFINITY as P, Popover as Q, Popover_content as R, Popover_trigger as S, Portal as T, Radio_group as U, Radio_group_item as V, SPARSE as W, Scroll_area as X, Scroll_area_corner as Y, Scroll_area_scrollbar as Z, Scroll_area_thumb as _, Accordion_content as a, Select as a0, Select_content as a1, Select_group as a2, Select_item as a3, Select_scroll_down_button as a4, Select_scroll_up_button as a5, Select_trigger as a6, Select_viewport as a7, Separator as a8, SvelteSet as a9, head as aA, html as aB, index_server_exports as aC, is_plain_object as aD, is_primitive as aE, is_valid_array_index as aF, is_valid_array_len as aG, mergeProps as aH, noop$1 as aI, onDestroy as aJ, readable as aK, render as aL, run as aM, setContext as aN, spread_props as aO, store_get as aP, store_set as aQ, stringify as aR, stringify_key as aS, stringify_string as aT, uneval as aU, unsubscribe_stores as aV, useId as aW, valid_array_indices as aX, writable as aY, Tooltip as aa, Tooltip_arrow as ab, Tooltip_content as ac, Tooltip_provider as ad, Tooltip_trigger as ae, UNDEFINED as af, asClassComponent as ag, attr as ah, attr_class as ai, attr_style as aj, attributes as ak, bind_props as al, clsx as am, clsx$1 as an, createSubscriber as ao, derived as ap, derived$1 as aq, element as ar, ensure_array_like as as, enumerable_symbols as at, escape_html as au, fallback as av, get$3 as aw, getContext as ax, get_type as ay, hasContext as az, Accordion_header as b, Accordion_item as c, Accordion_trigger as d, Avatar as e, Avatar_fallback as f, Avatar_image as g, Command_empty as h, Command_group as i, Command_group_heading as j, Command_group_items as k, Command_input as l, Command_item as m, Command_list as n, Command_separator as o, Dialog as p, Dialog_close as q, Dialog_content as r, Dialog_description as s, Dialog_overlay as t, Dialog_title as u, Dialog_trigger as v, Dropdown_menu_content as w, MediaQuery as x, Menu as y, Menu_group as z };
//# sourceMappingURL=ui-libs-BjzLDLAh.js.map
