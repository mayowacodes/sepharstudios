import { b as push_element, d as pop_element, e as ensure_array_like, l as escape_html, k as attr_class, i as stringify, F as FILENAME } from './ui-libs-Yf6h8PPk.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      ...
      $$renderer2.push(`</div>`);
      pop_element();
      $$renderer2.push(` <div class="bg-linear-to-r from-purple-600/20 to-blue-600/20 border border-purple-500/30 rounded-xl p-6">`);
      ...
      $$renderer2.push(`<!--]--></div>`);
      pop_element();
      $$renderer2.push(` <div class="bg-linear-to-r from-green-600/20 to-blue-600/20 border border-green-500/30 rounded-xl p-8">`);
...
//# sourceMappingURL=_page.svelte-COsno_Ep.js.map
