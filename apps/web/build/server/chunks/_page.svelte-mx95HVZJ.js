import { b as push_element, d as pop_element, e as ensure_array_like, g as attr, k as attr_class, F as FILENAME, i as stringify } from './ui-libs-Yf6h8PPk.js';

_page[FILENAME] = "src/routes/kids/kiddies/profile/+page.svelte";
  ...
  $$renderer.component(
    ($$renderer2) => {
      ...
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        ...
        push_element($$renderer2, "img", 22, 8);
        pop_element();
      }
      $$renderer2.push(`<!--]--></div>`);
      pop_element();
      $$renderer2.push(` <p class="mt-6 text-lg">`);
      push_element($$renderer2, "p", 30, 4);
...
//# sourceMappingURL=_page.svelte-mx95HVZJ.js.map
