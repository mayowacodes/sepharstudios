import { Z as refunds, c as user, d as db, _ as paymentIntents, P as paystackSubscriptions } from './drizzle-C3SH12nS.js';
import { r as requireAdmin } from './admin-auth-C5lShqv4.js';
import { n as notify } from './notify-B7qJZlU5.js';
import { c as createRefund } from './paystack-DWLDZ9qO.js';
...
var POST = async ({ locals, request }) => {
	...
	if (processor === "stripe") {
		const { getStripe, isStripeConfigured } = await import('./stripe-aF2QC30u.js');
...
export { GET, POST };
//# sourceMappingURL=_server.ts-GlnAuSMb.js.map
