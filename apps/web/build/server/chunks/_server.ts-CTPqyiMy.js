import { w as db, M as mediaLibrary, N as mediaWatchProgress, n as contentShares, aj as watchSessionMeta } from './drizzle-CKUH7ukq.js';
import { n as notify, a as notifyAdmins } from './notify-DpHZNtZn.js';
...
var PATCH = async ({ params, locals, request }) => {
	...
	if (updated.status === "published" && [
		...
		const { indexMedia, isMeiliConfigured } = await import('./meilisearch-D8LbED_W.js');
...
//# sourceMappingURL=_server.ts-CTPqyiMy.js.map
