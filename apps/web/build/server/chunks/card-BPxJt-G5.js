import { a as attributes, c as clsx$1, t as bind_props } from './index.js-DwRgOKlO.js';
...
function Card_header($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<div${attributes({
			...
			class: clsx$1(cn("@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 px-6 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-6", className)),
			...restProps
		})}>`);
		children?.($$renderer);
		$$renderer.push(`<!----></div>`);
...
function Card_title($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<div${attributes({
			...
			class: clsx$1(cn("leading-none font-semibold", className)),
			...restProps
		})}>`);
		children?.($$renderer);
		$$renderer.push(`<!----></div>`);
...
export { Card as C, Card_header as a, Card_description as b, Card_title as c, Card_content as d };
//# sourceMappingURL=card-BPxJt-G5.js.map
