import { aq as getContext, aC as onDestroy, at as head, an as escape_html, al as ensure_array_like, ai as derived, aa as attr, ab as attr_class, ac as attr_style, aK as stringify, aI as store_get, aH as spread_props, au as html, aO as unsubscribe_stores } from './ui-libs-TtGtWAGI.js';
import { S as SiteMeta } from './constants-ChVx7CIu.js';
import { I as Icon } from './Icon-CGEdwVFL.js';
import { c as copilotContext } from './copilot-CdP6Akkb.js';
...
function VideoPlayer($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		*/
		let { poster, title, subtitles = [], descriptions = []} = $$props;
		let playing = false;
		let volume = 1;
		let muted = false;
...
//# sourceMappingURL=_page.svelte-DT2j9I1s.js.map
