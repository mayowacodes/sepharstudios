import { p as defineChain, r as getAddress, g as SwitchChainError, G as numberToHex, h as UserRejectedRequestError, Z as withRetry, _ as withTimeout, R as ResourceUnavailableRpcError, n as createClient, y as http, M as polygon } from './polygon-D78JtxJX.js';
        ...
        async getProvider() {
            if (!walletProvider) {
                const { createCoinbaseWalletSDK } = await (() => {
                    ...
                    try {
                        return import('./index-BNWnakZo.js').then(function (n) { return n.i; });
                    }
                    catch {
        ...
        async getProvider({ chainId } = {}) {
            async function initProvider() {
                ...
                const { EthereumProvider } = await (() => {
                    // safe webpack optional peer dependency dynamic import
                    try {
                        return import('./index.es-KhyYp4mt.js').then(function (n) { return n.w; });
                    }
                    catch {
...
//# sourceMappingURL=config-BPBzrUzB.js.map
