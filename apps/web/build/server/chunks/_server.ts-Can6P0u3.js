import { d as db, m as mediaLibrary, k as mediaWatchProgress, ah as contentShares, ai as watchSessionMeta } from './drizzle-CsnNxG5m.js';
import { p as permanentlyDeleteContent } from './content-delete-DJelluQM.js';
import { n as notify, a as notifyAdmins } from './notify-CeDVqKm9.js';
...
import './minio-B7gIRc1u.js';
import 'minio';
import './temporal-client-QLX8fevQ.js';
...
var PATCH = async ({ params, locals, request }) => {
	...
	if (updated.status === "published" && [
		...
		const { indexMedia, isMeiliConfigured } = await import('./meilisearch-QOgiULGD.js');
...
//# sourceMappingURL=_server.ts-Can6P0u3.js.map
