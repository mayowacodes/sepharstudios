import { ae as bind_props, ai as derived, ab as attr_class, an as escape_html, aG as setContext, a6 as Tooltip_provider$1, aH as spread_props, t as MediaQuery, ad as attributes, ag as clsx$1, aK as stringify, aq as getContext, aa as attr, al as ensure_array_like, aA as mergeProps, a3 as Tooltip$1, a7 as Tooltip_trigger$1, a5 as Tooltip_content$1, a4 as Tooltip_arrow, I as Portal } from './ui-libs-TtGtWAGI.js';
import { b as signOut } from './auth-client-cjgC9VE2.js';
import { g as getNavigation, C as Constants, H as House } from './constants-ChVx7CIu.js';
import { I as Icon } from './Icon-CGEdwVFL.js';
import { S as Sheet, a as Sheet_content, c as Sheet_header, d as Sheet_title, b as Sheet_description, C as Chevron_right } from './sheet-DgeY35Gk.js';
import { L as Log_out } from './log-out-sERF3tP4.js';
import { U as User } from './user-BR-ZR5dM.js';
import { t as toast } from './toast-state.svelte-BmEXLjm2.js';
import { t as toggleMode } from './dist-DR3TaXmC.js';
import { p as page } from './state-Cm-InHWy.js';
import { c as cn } from './utils2-C8dWVCac.js';
import { B as Button, b as buttonVariants } from './button-D9M18H3C.js';
import { A as Avatar, b as Avatar_image, a as Avatar_fallback } from './avatar-BYbCDgEj.js';
import { D as Dropdown_menu, f as Dropdown_menu_trigger, a as Dropdown_menu_content, d as Dropdown_menu_label, e as Dropdown_menu_separator, c as Dropdown_menu_item, b as Dropdown_menu_group } from './dropdown-menu-Dg5aZQ3h.js';
import { S as Separator } from './separator-C04lBAE9.js';
import { Q as QueryClientProvider, i as infiniteScroll, u as useQueryClient, g as getRoleBadgeVariant } from './fxn-BfW2N3Mt.js';
...
function Sidebar_inset($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<main${attributes({
			...
			class: clsx$1(cn("bg-background relative flex w-full flex-1 flex-col", "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2", className)),
			...restProps
		})}>`);
		children?.($$renderer);
		$$renderer.push(`<!----></main>`);
	...
	$$renderer.component(($$renderer) => {
		...
		function $$render_inner($$renderer) {
			if (collapsible === "none") {
				...
				$$renderer.push("<!--[-1-->");
				$$renderer.push(`<div class="text-sidebar-foreground group peer hidden md:block"${attr("data-state", sidebar.state)}${attr("data-collapsible", sidebar.state === "collapsed" ? collapsible : "")}${attr("data-variant", variant)}${attr("data-side", side)} data-slot="sidebar"><div data-slot="sidebar-gap"${attr_class(clsx$1(cn("relative w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear", "group-data-[collapsible=offcanvas]:w-0", "group-data-[side=right]:rotate-180", variant === "floating" || variant === "inset" ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]" : "group-data-[collapsible=icon]:w-(--sidebar-width-icon)")))}></div> <div${attributes({
...
function Breadcrumb_item($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<li${attributes({
			...
			class: clsx$1(cn("inline-flex items-center gap-1.5", className)),
			...restProps
		})}>`);
		children?.($$renderer);
		$$renderer.push(`<!----></li>`);
...
function Breadcrumb_separator($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<li${attributes({
			...
			role: "presentation",
			"aria-hidden": "true",
			class: clsx$1(cn("[&>svg]:size-3.5", className)),
			...restProps
		})}>`);
		if (children) {
			$$renderer.push("<!--[0-->");
...
function Breadcrumb_list($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<ol${attributes({
			...
			class: clsx$1(cn("text-muted-foreground flex flex-wrap items-center gap-1.5 text-sm break-words sm:gap-2.5", className)),
			...restProps
		})}>`);
		children?.($$renderer);
		$$renderer.push(`<!----></ol>`);
...
function Devtools($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		*/
		let { client = useQueryClient()} = $$props;
...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { children } = $$props;
		const currentAchievement = derived(() => null);
...
//# sourceMappingURL=_layout.svelte-DCmCFd02.js.map
