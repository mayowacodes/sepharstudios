import { k as head, am as store_get, q as escape_html, b as ensure_array_like, x as attr_class, i as attr, an as unsubscribe_stores, ax as get$2 } from './index.js-CxPEndTa.js';
import { A as Arrow_right } from './arrow-right-CVEtli2e.js';
import { C as Calendar } from './calendar-BawMMHhq.js';
import { C as Coins } from './coins-HZ1N_e-W.js';
import { G as Gift } from './gift-CHWMqRnF.js';
import { L as Lock } from './lock-1PWDA65t.js';
import { T as Trending_up } from './trending-up-CDrIST_v.js';
import { W as Wallet } from './wallet-CRqOK7UE.js';
import { B as Button } from './button-DtPBvYl-.js';
import { i as isConnected, c as connectWallet, w as walletAddress, a as walletGeneration } from './wallet2-BkFmz2a_.js';
import { s as stcToken } from './contracts2-D1l6q83i.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		async function loadStakingData() {
			const startGen = get$2(walletGeneration);
			...
			try {
				...
				if (get$2(walletGeneration) !== startGen) return;
				balance = bal;
...
//# sourceMappingURL=_page.svelte-Dnsg_hW6.js.map
