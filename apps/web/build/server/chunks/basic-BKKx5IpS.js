...
import 'events';
import './index.es-CGqpYBjs.js';
import 'crypto';
import 'node:crypto';
import './index-Cr2ZHdiA.js';
import 'os';
import 'path';
...
const QrCodeUtil = {
    generate({ uri, size, logoSize, dotColor = '#141414' }) {
        ...
        Object.entries(circlesToConnect)
            ...
            .forEach(([cx, cys]) => {
            cys.forEach(cy => {
                dots.push(svg$1 `<circle cx=${cx} cy=${cy} fill=${dotColor} r=${cellSize / CIRCLE_SIZE_MODIFIER} />`);
            });
        });
        Object.entries(circlesToConnect)
...
const networkSvgMd = svg$1 `<svg  viewBox="0 0 48 54" fill="none">
  <path
...
//# sourceMappingURL=basic-BKKx5IpS.js.map
