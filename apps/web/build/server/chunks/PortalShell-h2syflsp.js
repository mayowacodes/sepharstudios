import { s as spread_props, i as attr, t as bind_props, am as store_get, b as ensure_array_like, x as attr_class, ae as attr_style, v as stringify, q as escape_html, an as unsubscribe_stores, f as derived, w as writable, aK as tick, aL as snapshot, a as attributes } from './index.js-CxPEndTa.js';
import { I as Icon } from './Icon-Bw1rnKTC.js';
import { A as Activity } from './activity-HOlvKMcx.js';
import { B as Banknote } from './banknote-Bga5PAMF.js';
import { B as Bell } from './bell-BrL1tBn8.js';
import { C as Chart_column } from './chart-column-Clm7jeZ1.js';
import { C as Check } from './check-Dd25bh0_.js';
import { C as Chevron_right } from './chevron-right-BXeoMTPQ.js';
import { C as Coins } from './coins-HZ1N_e-W.js';
import { E as External_link } from './external-link-BtRO0xQl.js';
import { F as File_check } from './file-check-Br5bL08N.js';
import { F as File_text } from './file-text-By5QqCz6.js';
import { H as House } from './house-6lS0tROn.js';
import { L as Landmark } from './landmark-BiAsGGZg.js';
import { L as Loader_circle } from './loader-circle-B0HKi6ku.js';
import { L as Log_out } from './log-out-Bf9yLhaA.js';
import { M as Megaphone } from './megaphone-HgPRtjd7.js';
import { M as Message_square } from './message-square-DuXesl7d.js';
import { M as Monitor } from './monitor-BOrhpr28.js';
import { S as Sidebar_provider, c as Sidebar, a as Sidebar_inset, d as Sidebar_header, e as Sidebar_content, f as Sidebar_footer, b as Sidebar_trigger, j as Sidebar_group, k as Sidebar_group_label, n as Sidebar_group_content, i as Sidebar_menu, l as Sidebar_menu_item, h as Sun, M as Moon, m as Sidebar_menu_button } from './sidebar-5BfDywwL.js';
import { P as Plus } from './plus-NyypAj8P.js';
import { S as Search } from './search-DTs5QrbF.js';
import { S as Send } from './send-BkIRApbm.js';
import { S as Settings } from './settings-BAao4cwu.js';
...
import { T as Triangle_alert } from './triangle-alert-DrDB-0_5.js';
import { U as Upload } from './upload-ouNUZcQF.js';
import { U as User } from './user-DfNTMTjp.js';
import { U as Users } from './users-BHfWNfsK.js';
import { V as Video } from './video-BLlujA8B.js';
import { W as Wallet } from './wallet-CRqOK7UE.js';
import { X } from './x-57ZXvvuj.js';
import { Z as Zap } from './zap-Cm0mFJ3v.js';
import { t as toast } from './toast-state.svelte-jhYVYtU8.js';
import { r as resetMode, s as setMode, d as derivedMode } from './dist2-D60iehlE.js';
import { g as goto } from './client-DsZfmj3l.js';
import { p as page } from './state-p7jw8P-1.js';
import { S as Separator } from './separator-16ygnFBZ.js';
import { D as Dropdown_menu, a as Dropdown_menu_trigger, b as Dropdown_menu_content, d as Dropdown_menu_separator, e as Dropdown_menu_item, g as Dropdown_menu_sub, h as Dropdown_menu_sub_trigger, i as Dropdown_menu_sub_content } from './dropdown-menu-ZI0zkml5.js';
import { e as Command_dialog, a as Command_input, b as Command_list, c as Command_empty, f as Command_group, g as Command_separator, d as Command_item } from './command-Bm9SqMGA.js';
import { DefaultChatTransport, AbstractChat } from 'ai';

//#region ../../node_modules/.bun/@lucide+svelte@1.24.0+5726b9c92ebd8575/node_modules/@lucide/svelte/dist/icons/pin.svelte
...
export { PortalShell as P };
//# sourceMappingURL=PortalShell-h2syflsp.js.map
