import { t as bind_props, D as Menu, s as spread_props, E as Menu_trigger, F as Dropdown_menu_content$1, P as Portal, a as attributes, c as clsx$1, G as Menu_separator, H as Menu_item, I as Menu_group, J as Menu_sub, K as Menu_sub_trigger, L as Menu_sub_content } from './index.js-BP8aAXBX.js';
...
function Dropdown_menu_label($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<div${attributes({
			...
			"data-inset": inset,
			class: clsx$1(cn("px-2 py-1.5 text-sm font-semibold data-inset:ps-8", className)),
			...restProps
		})}>`);
		children?.($$renderer);
		$$renderer.push(`<!----></div>`);
				...
				Menu_sub_trigger($$renderer, spread_props([
					...
					restProps,
					{
						...
						children: ($$renderer) => {
							children?.($$renderer);
							$$renderer.push(`<!----> `);
							Chevron_right($$renderer, { class: "ms-auto size-4" });
							$$renderer.push(`<!---->`);
						},
						$$slots: { default: true }
					}
...
export { Dropdown_menu as D, Dropdown_menu_trigger as a, Dropdown_menu_content as b, Dropdown_menu_label as c, Dropdown_menu_separator as d, Dropdown_menu_item as e, Dropdown_menu_group as f, Dropdown_menu_sub as g, Dropdown_menu_sub_trigger as h, Dropdown_menu_sub_content as i };
//# sourceMappingURL=dropdown-menu-95C89c6A.js.map
