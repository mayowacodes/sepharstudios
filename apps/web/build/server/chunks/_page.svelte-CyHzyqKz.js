import { k as head, b as ensure_array_like, q as escape_html, f as derived, t as bind_props, ao as Accordion$1, s as spread_props, ap as store_set, am as store_get, an as unsubscribe_stores, w as writable, aq as Accordion_item$1, ar as Accordion_header, as as Accordion_content$1, x as attr_class, c as clsx$1, at as Accordion_trigger$1 } from './index.js-CxPEndTa.js';
import { I as Icon } from './Icon-Bw1rnKTC.js';
import { C as Chevron_down } from './chevron-down-D3ODB46C.js';
import { C as Circle_question_mark } from './circle-question-mark-r9OQ4ZcA.js';
...
import { T as Textarea } from './textarea-CMUbtA1y.js';
			...
			if (Accordion_content$1) {
				...
				Accordion_content$1($$renderer, spread_props([
					...
					restProps,
					{
						...
						children: ($$renderer) => {
							$$renderer.push(`<div${attr_class(clsx$1(cn("pt-0 pb-4", className)))}>`);
							children?.($$renderer);
							$$renderer.push(`<!----></div>`);
						},
						$$slots: { default: true }
...
//# sourceMappingURL=_page.svelte-CyHzyqKz.js.map
