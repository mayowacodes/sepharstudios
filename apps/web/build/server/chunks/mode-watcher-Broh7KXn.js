import { g as attr, b as push_element, d as pop_element, h as head, m as html, y as createSubscriber, M as MediaQuery, F as FILENAME, r as run } from './ui-libs-Yf6h8PPk.js';
...
Mode_watcher_lite[FILENAME] = "C:/Users/Mayowa Animasaun/Documents/Projects/sepharstudios/node_modules/mode-watcher/dist/components/mode-watcher-lite.svelte";
  ...
  $$renderer.component(
    ($$renderer2) => {
      ...
      if (themeColors2) {
        ...
        push_element($$renderer2, "meta", 11, 1);
        pop_element();
      } else {
        $$renderer2.push("<!--[!-->");
      }
...
Mode_watcher_lite.render = function() {
  throw new Error("Component.render(...) is no longer valid in Svelte 5. See https://svelte.dev/docs/svelte/v5-migration-guide#Components-are-no-longer-classes for more information");
};
Mode_watcher_full[FILENAME] = "C:/Users/Mayowa Animasaun/Documents/Projects/sepharstudios/node_modules/mode-watcher/dist/components/mode-watcher-full.svelte";
function Mode_watcher_full($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      let { trueNonce = "", initConfig, themeColors: themeColors2 } = $$props;
      head("1niqolg", $$renderer2, ($$renderer3) => {
        if (themeColors2) {
          $$renderer3.push("<!--[-->");
...
Mode_watcher_full.render = function() {
  throw new Error("Component.render(...) is no longer valid in Svelte 5. See https://svelte.dev/docs/svelte/v5-migration-guide#Components-are-no-longer-classes for more information");
};
Mode_watcher[FILENAME] = "C:/Users/Mayowa Animasaun/Documents/Projects/sepharstudios/node_modules/mode-watcher/dist/components/mode-watcher.svelte";
...
Mode_watcher.render = function() {
  throw new Error("Component.render(...) is no longer valid in Svelte 5. See https://svelte.dev/docs/svelte/v5-migration-guide#Components-are-no-longer-classes for more information");
};

export { Mode_watcher as M, toggleMode as t };
//# sourceMappingURL=mode-watcher-Broh7KXn.js.map
