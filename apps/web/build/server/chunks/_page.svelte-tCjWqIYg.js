import { q as escape_html, b as ensure_array_like, f as derived, a as attributes, c as clsx$1, t as bind_props, x as attr_class, aA as Select$1, s as spread_props, m as createSubscriber, aB as Select_trigger$1, aC as Select_content$1, aD as Select_viewport, P as Portal, aE as Select_scroll_up_button$1, aF as Select_scroll_down_button$1, aG as Select_group$1, aH as Select_item$1 } from './index.js-CxPEndTa.js';
import { a as adminRoles } from './constants-BiiFHz9b.js';
import { I as Icon } from './Icon-Bw1rnKTC.js';
import { C as Check } from './check-Dd25bh0_.js';
import { C as Chevron_down } from './chevron-down-D3ODB46C.js';
import { C as Circle_alert } from './circle-alert-B-95ErOI.js';
import { L as Loader_circle } from './loader-circle-B0HKi6ku.js';
import { S as Search } from './search-DTs5QrbF.js';
import { T as Trash_2 } from './trash-2-jTJ5MS1o.js';
import { T as Triangle_alert } from './triangle-alert-DrDB-0_5.js';
import { U as Users } from './users-BHfWNfsK.js';
import { a as admin } from './auth-client-D2kTnJzE.js';
...
import { D as Dialog, b as Dialog_content, a as Dialog_header, c as Dialog_title, d as Dialog_description, f as Dialog_footer } from './dialog-BZDWaiEy.js';
import { A as Avatar, a as Avatar_image, b as Avatar_fallback } from './avatar-DwYkzjOK.js';
import { i as infiniteScroll, g as getRoleBadgeVariant, r as roles } from './fxn-DyAkodKS.js';
import { B as Badge } from './badge-BfVc17Ti.js';
import { L as Loading_spinner } from './loading-spinner-BQeZio1P.js';
import { t as tv } from './index-BoGG3uCW.js';
...
function Identity($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (user) {
			...
			if (direction === "left") {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<div${attr_class(clsx$1(cn("flex items-center gap-2 px-1 py-1.5 text-left text-sm", className)))}>`);
				if (Avatar) {
					$$renderer.push("<!--[-->");
					Avatar($$renderer, {
			...
			if (direction === "right") {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<div${attr_class(clsx$1(cn("flex items-center justify-end gap-2 px-1 py-1.5 text-sm", className)))}><div class="grid flex-1 text-right text-sm leading-tight"><span class="truncate font-medium">${escape_html(user?.name)}</span> <span class="truncate text-xs text-muted-foreground">${escape_html(user?.email)}</span></div> `);
				if (Avatar) {
					$$renderer.push("<!--[-->");
					Avatar($$renderer, {
						class: "size-8 rounded-lg",
...
//# sourceMappingURL=_page.svelte-tCjWqIYg.js.map
