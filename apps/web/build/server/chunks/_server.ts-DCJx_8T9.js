...
import { a as attachCatalogProgress } from './catalog-progress-DrcH2Woc.js';
import { j as json } from './index.js-DwRgOKlO.js';
import { and, inArray, eq, desc, sql, asc } from 'drizzle-orm';
import 'drizzle-orm/postgres-js';
import 'postgres';
import 'drizzle-orm/pg-core';

//#region src/routes/api/home/+server.ts
/**
...
*/
async function buildHomePayload({ locals }) {
	try {
...
var GET = async (event) => json(await buildHomePayload(event));

export { GET };
//# sourceMappingURL=_server.ts-DCJx_8T9.js.map
