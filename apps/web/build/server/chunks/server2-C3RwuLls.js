...
//#region src/lib/authentication/server.ts
/**
* Send an email using a webhook endpoint
* Configure EMAIL_WEBHOOK in your .env file to point to your email service
*/
var sendEmailAction = async (options) => {
	const webhookUrl = private_env.EMAIL_WEBHOOK;
	if (!webhookUrl) {
...
export { sendEmailAction as s };
//# sourceMappingURL=server2-C3RwuLls.js.map
