import { h as head, b as push_element, d as pop_element, p as prevent_snippet_stringification, e as ensure_array_like, l as escape_html, s as spread_props, F as FILENAME } from './ui-libs-Yf6h8PPk.js';
import { C as Card, c as Card_content } from './card-title-Bb6tCQUO.js';
import { I as Icon } from './Icon-DVHDtCfs.js';
import { E as Eye } from './eye-CWFeuyca.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      ...
      $$renderer2.push(`<main class="container pt-32 pb-16 mx-auto px-4">`);
      ...
      $$renderer2.push(`<h1 class="text-4xl sm:text-6xl font-bold tracking-tight text-primary">`);
      ...
      $$renderer2.push(`Sephar Studios is dedicated to producing excellent video content that draws people to the kingdom of God.</p>`);
      pop_element();
        ...
        children: prevent_snippet_stringification(($$renderer3) => {
          Card_content($$renderer3, {
            ...
            children: prevent_snippet_stringification(($$renderer4) => {
              ...
              Target($$renderer4, { class: "w-8 h-8 text-primary" });
              $$renderer4.push(`<!----> <h2 class="text-2xl font-bold">`);
        ...
        children: prevent_snippet_stringification(($$renderer3) => {
          Card_content($$renderer3, {
            ...
            children: prevent_snippet_stringification(($$renderer4) => {
              ...
              Eye($$renderer4, { class: "w-8 h-8 text-primary" });
              $$renderer4.push(`<!----> <h2 class="text-2xl font-bold">`);
      ...
      $$renderer2.push(`<h2 class="text-3xl font-bold text-primary mb-6">`);
      ...
      $$renderer2.push(`<h2 class="text-3xl font-bold text-primary text-center mb-8">`);
      push_element($$renderer2, "h2", 98, 6);
      $$renderer2.push(`Our Journey</h2>`);
      pop_element();
      $$renderer2.push(` <div class="absolute left-1/2 -translate-x-px h-full w-0.5 bg-primary/20 hidden sm:block">`);
      ...
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        ...
        $$renderer2.push(`<div class="relative flex flex-col sm:flex-row items-center gap-8">`);
        push_element($$renderer2, "div", 102, 10);
        $$renderer2.push(`<div class="w-full sm:w-24 text-center sm:text-right flex-none">`);
        push_element($$renderer2, "div", 103, 12);
        $$renderer2.push(`<span class="text-primary font-bold">`);
        push_element($$renderer2, "span", 104, 14);
        $$renderer2.push(`${escape_html(milestone.year)}</span>`);
        pop_element();
        $$renderer2.push(`</div>`);
        pop_element();
        $$renderer2.push(` <div class="absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-primary hidden sm:block">`);
        push_element($$renderer2, "div", 106, 12);
        $$renderer2.push(`</div>`);
        pop_element();
        $$renderer2.push(` <div class="flex-1 bg-muted/30 p-4 rounded-lg border border-primary/20 w-full">`);
...
//# sourceMappingURL=_page.svelte-C63Ika0L.js.map
