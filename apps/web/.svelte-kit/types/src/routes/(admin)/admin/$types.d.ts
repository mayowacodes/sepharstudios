...
type LayoutRouteId = RouteId | "/(admin)/admin" | "/(admin)/admin/abuse" | "/(admin)/admin/ai-runs" | "/(admin)/admin/analytics" | "/(admin)/admin/communications" | "/(admin)/admin/content" | "/(admin)/admin/creator-applications" | "/(admin)/admin/creators" | "/(admin)/admin/dashboard" | "/(admin)/admin/disputes" | "/(admin)/admin/events" | "/(admin)/admin/governance" | "/(admin)/admin/governance/create" | "/(admin)/admin/governance/emergency" | "/(admin)/admin/governance/execution" | "/(admin)/admin/governance/proposals" | "/(admin)/admin/governance/reports" | "/(admin)/admin/governance/roles" | "/(admin)/admin/governance/treasury" | "/(admin)/admin/payouts" | "/(admin)/admin/policies" | "/(admin)/admin/promo" | "/(admin)/admin/refunds" | "/(admin)/admin/review" | "/(admin)/admin/review/[id]" | "/(admin)/admin/settings" | "/(admin)/admin/submissions" | "/(admin)/admin/system-health" | "/(admin)/admin/tax-forms" | "/(admin)/admin/tokenomics" | "/(admin)/admin/users" | "/(admin)/admin/users/[id]" | "/(admin)/admin/workflow"
