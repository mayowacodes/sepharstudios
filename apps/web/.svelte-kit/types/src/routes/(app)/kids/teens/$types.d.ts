...
type LayoutRouteId = RouteId | "/(app)/kids/teens" | "/(app)/kids/teens/documentaries" | "/(app)/kids/teens/movies" | "/(app)/kids/teens/profile" | "/(app)/kids/teens/shows"
