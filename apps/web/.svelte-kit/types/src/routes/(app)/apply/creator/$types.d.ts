...
type RouteParams = {  };
type RouteId = '/(app)/apply/creator';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/apply/creator/+page.server.js').load>>>>>>;
