...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/about" | "/(app)/access-denied" | "/(app)/apply/creator" | "/(app)/archive" | "/(app)/browse" | "/(app)/careers" | "/(app)/checkout" | "/(app)/contact" | "/(app)/creators/[id]" | "/(app)/device-support" | "/(app)/documentaries" | "/(app)/documentaries/[slug]" | "/(app)/exchange" | "/(app)/faq" | "/(app)/features" | "/(app)/guidelines" | "/(app)/help" | "/(app)/liquidity" | "/(app)/movies" | "/(app)/movies/[slug]" | "/(app)/my-studios" | "/(app)/offline" | "/(app)/plans" | "/(app)/press" | "/(app)/privacy" | "/(app)/search" | "/(app)/shows" | "/(app)/shows/[slug]" | "/(app)/sponsorships" | "/(app)/staking" | "/(app)/terms" | "/(app)/token" | "/(app)/webinars"
