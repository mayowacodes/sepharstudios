...
type LayoutRouteId = RouteId | "/(protected)/achievements" | "/(protected)/dashboard" | "/(protected)/documentation" | "/(protected)/milestones" | "/(protected)/parental-controls" | "/(protected)/profile" | "/(protected)/profiles" | "/(protected)/settings" | "/(protected)/users" | "/(protected)/watchlist"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(protected)/+layout.server.js').load>>>>>>;
