import { Ct as derived, Lt as attr, Ot as spread_props, Rt as clsx, bt as attr_style, jt as stringify, yt as attr_class, zt as escape_html } from "./ui-libs.js";
...
function Sparkline($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		*/
		...
		$$renderer.push(`<svg${attr("viewBox", `0 0 ${width} ${height}`)} width="100%"${attr("height", height)} preserveAspectRatio="none"${attr_class(clsx(klass))} aria-hidden="true">`);
		if (fillGradient) {
			$$renderer.push("<!--[0-->");
