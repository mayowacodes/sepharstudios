	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/ads/vast-tag/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				pattern: /^\/kids\/?$/,
				params: [],
				page: { layouts: [0,8,], errors: [1,,], leaf: 120 },
				endpoint: null
			},
			{
				id: "/kids/kiddies",
			...
			},
			{
				...
				pattern: /^\/kids\/teens\/?$/,
				params: [],
				page: { layouts: [0,8,], errors: [1,,], leaf: 128 },
				endpoint: null
			},
			{
				id: "/kids/teens/[slug]",
			...
			},
			{
				...
				params: [],
				page: { layouts: [0,7,], errors: [1,,], leaf: 117 },
				endpoint: null
			},
			{
				id: "/(app)/terms",
