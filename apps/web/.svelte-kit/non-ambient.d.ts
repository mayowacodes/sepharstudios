...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/(web3)" | "/(protected)" | "/(creator)" | "/(auth)" | "/(app)" | "/(admin)" | "/" | "/(app)/about" | "/(admin)/admin" | "/(admin)/admin/analytics" | "/(admin)/admin/communications" | "/(admin)/admin/content" | "/(admin)/admin/creators" | "/(admin)/admin/policies" | "/(admin)/admin/review" | "/(admin)/admin/review/[id]" | "/(admin)/admin/settings" | "/(admin)/admin/test" | "/(admin)/admin/tokenomics" | "/(admin)/admin/workflow" | "/api" | "/api/auth" | "/api/auth/[...all]" | "/api/files" | "/api/users" | "/(app)/archive" | "/(auth)/auth" | "/(auth)/auth/forget-password" | "/(auth)/auth/forget-password/success" | "/(auth)/auth/login" | "/(auth)/auth/register" | "/(auth)/auth/reset-password" | "/(app)/contact" | "/(creator)/creator" | "/(creator)/creator/agreement" | "/(creator)/creator/analytics-help" | "/(creator)/creator/analytics" | "/(creator)/creator/best-practices" | "/(creator)/creator/content" | "/(creator)/creator/earnings" | "/(creator)/creator/events" | "/(creator)/creator/forum" | "/(creator)/creator/guidelines" | "/(creator)/creator/newsletter" | "/(creator)/creator/profile" | "/(creator)/creator/success-stories" | "/(creator)/creator/support" | "/(creator)/creator/tech-support" | "/(creator)/creator/test" | "/(creator)/creator/upload" | "/(protected)/dashboard" | "/(app)/documentaries" | "/(protected)/documentation" | "/(app)/faq" | "/(app)/features" | "/(app)/guidelines" | "/(app)/help" | "/(app)/kids" | "/(app)/kids/kiddies" | "/(app)/kids/kiddies/documentaries" | "/(app)/kids/kiddies/movies" | "/(app)/kids/kiddies/shows" | "/(app)/kids/profile" | "/(app)/kids/teens" | "/(app)/kids/teens/documentaries" | "/(app)/kids/teens/movies" | "/(app)/kids/teens/profile" | "/(app)/kids/teens/shows" | "/(app)/mayowa" | "/(app)/movies" | "/(app)/my-studios" | "/(app)/offline" | "/(app)/plans" | "/(app)/press" | "/(app)/privacy" | "/(protected)/profile" | "/(app)/shows" | "/(app)/sponsorships" | "/(web3)/subscription" | "/(app)/terms" | "/(web3)/tokens" | "/(protected)/users" | "/(protected)/users/components" | "/(web3)/wallet";
		RouteParams(): {
		...
		LayoutParams(): {
			...
			"/(app)/kids": Record<string, never>;
			"/(app)/kids/kiddies": Record<string, never>;
			"/(app)/kids/kiddies/documentaries": Record<string, never>;
			"/(app)/kids/kiddies/movies": Record<string, never>;
			"/(app)/kids/kiddies/shows": Record<string, never>;
			"/(app)/kids/profile": Record<string, never>;
			"/(app)/kids/teens": Record<string, never>;
			"/(app)/kids/teens/documentaries": Record<string, never>;
			"/(app)/kids/teens/movies": Record<string, never>;
			"/(app)/kids/teens/profile": Record<string, never>;
			"/(app)/kids/teens/shows": Record<string, never>;
