...
declare module "$app/types" {
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/(admin)": { id?: string };
			"/": { id?: string; all?: string; jobId?: string; contentId?: string; videoId?: string };
			...
			"/api": { id?: string; all?: string; jobId?: string; contentId?: string; videoId?: string };
			...
			"/api/admin/content/[id]/publish": { id: string };
			"/api/admin/content/[id]/review": { id: string };
			"/api/admin/creator-applications": { id?: string };
			"/api/admin/creator-applications/[id]": { id: string };
			"/api/admin/creator-applications/[id]/review": { id: string };
			...
			"/api/downloads/manifest/[id]": { id: string };
			"/api/encoder": { jobId?: string };
			"/api/encoder/jobs": { jobId?: string };
			"/api/encoder/jobs/[jobId]": { jobId: string };
			"/api/encoder/jobs/[jobId]/commit": { jobId: string };
			"/api/encoder/jobs/[jobId]/playback": { jobId: string };
		...
		Pathname(): "/" | "/about" | "/about/" | "/achievements" | "/achievements/" | "/admin" | "/admin/" | "/admin/analytics" | "/admin/analytics/" | "/admin/communications" | "/admin/communications/" | "/admin/content" | "/admin/content/" | "/admin/creator-applications" | "/admin/creator-applications/" | "/admin/creators" | "/admin/creators/" | "/admin/dashboard" | "/admin/dashboard/" | "/admin/governance" | "/admin/governance/" | "/admin/governance/create" | "/admin/governance/create/" | "/admin/governance/emergency" | "/admin/governance/emergency/" | "/admin/governance/execution" | "/admin/governance/execution/" | "/admin/governance/proposals" | "/admin/governance/proposals/" | "/admin/governance/reports" | "/admin/governance/reports/" | "/admin/governance/roles" | "/admin/governance/roles/" | "/admin/governance/treasury" | "/admin/governance/treasury/" | "/admin/policies" | "/admin/policies/" | "/admin/review" | "/admin/review/" | `/admin/review/${string}` & {} | `/admin/review/${string}/` & {} | "/admin/settings" | "/admin/settings/" | "/admin/test" | "/admin/test/" | "/admin/tokenomics" | "/admin/tokenomics/" | "/admin/workflow" | "/admin/workflow/" | "/api" | "/api/" | "/api/achievements" | "/api/achievements/" | "/api/admin" | "/api/admin/" | "/api/admin/ai" | "/api/admin/ai/" | "/api/admin/ai/config" | "/api/admin/ai/config/" | "/api/admin/ai/models" | "/api/admin/ai/models/" | "/api/admin/ai/test" | "/api/admin/ai/test/" | "/api/admin/analytics" | "/api/admin/analytics/" | "/api/admin/communications" | "/api/admin/communications/" | "/api/admin/communications/templates" | "/api/admin/communications/templates/" | "/api/admin/content" | "/api/admin/content/" | `/api/admin/content/${string}` & {} | `/api/admin/content/${string}/` & {} | `/api/admin/content/${string}/ppv` & {} | `/api/admin/content/${string}/ppv/` & {} | `/api/admin/content/${string}/publish` & {} | `/api/admin/content/${string}/publish/` & {} | `/api/admin/content/${string}/review` & {} | `/api/admin/content/${string}/review/` & {} | "/api/admin/creator-applications" | "/api/admin/creator-applications/" | `/api/admin/creator-applications/${string}` & {} | `/api/admin/creator-applications/${string}/` & {} | `/api/admin/creator-applications/${string}/review` & {} | `/api/admin/creator-applications/${string}/review/` & {} | "/api/admin/creators" | "/api/admin/creators/" | "/api/admin/governance" | "/api/admin/governance/" | "/api/admin/governance/approve" | "/api/admin/governance/approve/" | "/api/admin/governance/audit" | "/api/admin/governance/audit/" | "/api/admin/governance/emergency" | "/api/admin/governance/emergency/" | "/api/admin/governance/emergency/pause" | "/api/admin/governance/emergency/pause/" | "/api/admin/governance/execute" | "/api/admin/governance/execute/" | "/api/admin/governance/proposals" | "/api/admin/governance/proposals/" | "/api/admin/governance/queue" | "/api/admin/governance/queue/" | "/api/admin/governance/reports" | "/api/admin/governance/reports/" | "/api/admin/governance/roles" | "/api/admin/governance/roles/" | "/api/admin/governance/status" | "/api/admin/governance/status/" | "/api/admin/governance/timelock-queue" | "/api/admin/governance/timelock-queue/" | "/api/admin/governance/treasury" | "/api/admin/governance/treasury/" | "/api/admin/policies" | "/api/admin/policies/" | "/api/admin/reviews" | "/api/admin/reviews/" | "/api/admin/settings" | "/api/admin/settings/" | "/api/admin/settings/test-email" | "/api/admin/settings/test-email/" | "/api/admin/stats" | "/api/admin/stats/" | "/api/admin/tokenomics" | "/api/admin/tokenomics/" | "/api/admin/tokenomics/distribution" | "/api/admin/tokenomics/distribution/" | "/api/admin/users" | "/api/admin/users/" | "/api/admin/users/stats" | "/api/admin/users/stats/" | "/api/admin/workflow" | "/api/admin/workflow/" | "/api/admin/workflow/stats" | "/api/admin/workflow/stats/" | "/api/ai" | "/api/ai/" | "/api/ai/companion" | "/api/ai/companion/" | "/api/ai/creator-insights" | "/api/ai/creator-insights/" | "/api/ai/moderate" | "/api/ai/moderate/" | "/api/ai/nft" | "/api/ai/nft/" | "/api/ai/search" | "/api/ai/search/" | "/api/ai/tag" | "/api/ai/tag/" | "/api/ai/token-score" | "/api/ai/token-score/" | "/api/auth" | "/api/auth/" | `/api/auth/${string}` & {} | `/api/auth/${string}/` & {} | "/api/content" | "/api/content/" | "/api/content/kids" | "/api/content/kids/" | "/api/creator" | "/api/creator/" | "/api/creator/application" | "/api/creator/application/" | "/api/creator/content" | "/api/creator/content/" | "/api/creator/profile" | "/api/creator/profile/" | "/api/creator/stats" | "/api/creator/stats/" | "/api/downloads" | "/api/downloads/" | "/api/downloads/manifest" | "/api/downloads/manifest/" | `/api/downloads/manifest/${string}` & {} | `/api/downloads/manifest/${string}/` & {} | "/api/encoder" | "/api/encoder/" | "/api/encoder/jobs" | "/api/encoder/jobs/" | `/api/encoder/jobs/${string}` & {} | `/api/encoder/jobs/${string}/` & {} | `/api/encoder/jobs/${string}/commit` & {} | `/api/encoder/jobs/${string}/commit/` & {} | `/api/encoder/jobs/${string}/playback` & {} | `/api/encoder/jobs/${string}/playback/` & {} | "/api/encoder/pending" | "/api/encoder/pending/" | "/api/encoder/presigned" | "/api/encoder/presigned/" | "/api/encoder/process" | "/api/encoder/process/" | "/api/encoder/ready" | "/api/encoder/ready/" | "/api/files" | "/api/files/" | "/api/kids" | "/api/kids/" | "/api/kids/quiz" | "/api/kids/quiz/" | "/api/kids/quiz/generate" | "/api/kids/quiz/generate/" | "/api/kids/quiz/submit" | "/api/kids/quiz/submit/" | "/api/milestones" | "/api/milestones/" | "/api/notifications" | "/api/notifications/" | "/api/notifications/preferences" | "/api/notifications/preferences/" | "/api/parental" | "/api/parental/" | "/api/parental/report" | "/api/parental/report/" | "/api/payment" | "/api/payment/" | "/api/payment/initialize" | "/api/payment/initialize/" | "/api/payment/verify" | "/api/payment/verify/" | "/api/payment/webhook" | "/api/payment/webhook/" | "/api/playlists" | "/api/playlists/" | `/api/playlists/${string}` & {} | `/api/playlists/${string}/` & {} | `/api/playlists/${string}/items` & {} | `/api/playlists/${string}/items/` & {} | "/api/ppv" | "/api/ppv/" | "/api/ppv/check-access" | "/api/ppv/check-access/" | `/api/ppv/check-access/${string}` & {} | `/api/ppv/check-access/${string}/` & {} | "/api/ppv/purchase" | "/api/ppv/purchase/" | "/api/profiles" | "/api/profiles/" | `/api/profiles/${string}` & {} | `/api/profiles/${string}/` & {} | `/api/profiles/${string}/pin` & {} | `/api/profiles/${string}/pin/` & {} | "/api/recommendations" | "/api/recommendations/" | "/api/reviews" | "/api/reviews/" | `/api/reviews/${string}` & {} | `/api/reviews/${string}/` & {} | `/api/reviews/${string}/helpful` & {} | `/api/reviews/${string}/helpful/` & {} | "/api/subscriptions" | "/api/subscriptions/" | "/api/subscriptions/add-family" | "/api/subscriptions/add-family/" | "/api/subscriptions/cancel" | "/api/subscriptions/cancel/" | "/api/subscriptions/change-plan" | "/api/subscriptions/change-plan/" | "/api/subscriptions/send-otp" | "/api/subscriptions/send-otp/" | "/api/subscriptions/start-trial" | "/api/subscriptions/start-trial/" | "/api/subscriptions/status" | "/api/subscriptions/status/" | "/api/users" | "/api/users/" | `/api/users/${string}` & {} | `/api/users/${string}/` & {} | "/api/watch" | "/api/watch/" | "/api/watch/history" | "/api/watch/history/" | "/api/watch/progress" | "/api/watch/progress/" | `/api/watch/${string}` & {} | `/api/watch/${string}/` & {} | "/apply" | "/apply/" | "/apply/creator" | "/apply/creator/" | "/archive" | "/archive/" | "/auth" | "/auth/" | "/auth/forget-password" | "/auth/forget-password/" | "/auth/forget-password/success" | "/auth/forget-password/success/" | "/auth/login" | "/auth/login/" | "/auth/register" | "/auth/register/" | "/auth/reset-password" | "/auth/reset-password/" | "/careers" | "/careers/" | "/checkout" | "/checkout/" | "/contact" | "/contact/" | "/creator" | "/creator/" | "/creator/agreement" | "/creator/agreement/" | "/creator/analytics-help" | "/creator/analytics-help/" | "/creator/analytics" | "/creator/analytics/" | "/creator/best-practices" | "/creator/best-practices/" | "/creator/content" | "/creator/content/" | "/creator/earnings" | "/creator/earnings/" | "/creator/events" | "/creator/events/" | "/creator/forum" | "/creator/forum/" | "/creator/guidelines" | "/creator/guidelines/" | "/creator/newsletter" | "/creator/newsletter/" | "/creator/profile" | "/creator/profile/" | "/creator/success-stories" | "/creator/success-stories/" | "/creator/support" | "/creator/support/" | "/creator/tech-support" | "/creator/tech-support/" | "/creator/test" | "/creator/test/" | "/creator/upload" | "/creator/upload/" | "/dashboard" | "/dashboard/" | "/device-support" | "/device-support/" | "/documentaries" | "/documentaries/" | "/documentation" | "/documentation/" | "/faq" | "/faq/" | "/features" | "/features/" | "/guidelines" | "/guidelines/" | "/help" | "/help/" | "/kids" | "/kids/" | "/kids/kiddies" | "/kids/kiddies/" | "/kids/kiddies/bible-quiz" | "/kids/kiddies/bible-quiz/" | "/kids/kiddies/documentaries" | "/kids/kiddies/documentaries/" | "/kids/kiddies/movies" | "/kids/kiddies/movies/" | "/kids/kiddies/profile" | "/kids/kiddies/profile/" | "/kids/kiddies/shows" | "/kids/kiddies/shows/" | "/kids/teens" | "/kids/teens/" | "/mayowa" | "/mayowa/" | "/milestones" | "/milestones/" | "/movies" | "/movies/" | "/my-studios" | "/my-studios/" | "/offline" | "/offline/" | "/parental-controls" | "/parental-controls/" | "/plans" | "/plans/" | "/press" | "/press/" | "/privacy" | "/privacy/" | "/profiles" | "/profiles/" | "/profile" | "/profile/" | "/settings" | "/settings/" | "/shows" | "/shows/" | "/sponsorships" | "/sponsorships/" | "/subscription" | "/subscription/" | "/terms" | "/terms/" | "/tokens" | "/tokens/" | "/token" | "/token/" | "/users" | "/users/" | "/users/components" | "/users/components/" | "/wallet" | "/wallet/" | "/watchlist" | "/watchlist/" | "/watch" | "/watch/" | `/watch/${string}` & {} | `/watch/${string}/` & {};
