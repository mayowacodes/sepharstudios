<!-- Creator Portal Layout — wraps every /creator route in the unified
     PortalShell. Replaces CreatorNav + CreatorMobileNav with a single
     collapsible left sidebar + Copilot rail + ⌘K palette. Auth-gating
     stays — anonymous users see the sign-in prompt instead. -->
<script lang="ts">
  import '../../../app.css';
