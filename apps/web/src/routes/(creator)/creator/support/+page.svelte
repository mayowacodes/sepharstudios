    ...
    <div class="lg:col-span-3">
      <div class="surface-2 backdrop-blur-sm rounded-xl p-6">
        {#if activeSection === 'overview'}
          <div class="space-y-6">
            <div>
              <h2 class="text-2xl font-bold text-foreground mb-4">Welcome to Creator Support</h2>
        ...
        {:else if activeSection === 'getting-started'}
          <div class="space-y-6">
            <div>
              <h2 class="text-2xl font-bold text-foreground mb-4">Getting Started</h2>
              ...
              {#each [
                ...
                <div class="surface-1 rounded-lg p-4">
                  <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                      <h3 class="text-lg font-medium text-foreground mb-2">{item.title}</h3>
                      <p class="text-foreground/80 mb-3">{item.desc}</p>
                      {#if item.link}
        ...
        {:else if activeSection === 'web3-help'}
          <div class="space-y-6">
            <div>
              <h2 class="text-2xl font-bold text-foreground mb-4">Web3 & STC Tokenomics Help</h2>
              <p class="text-foreground/80 mb-6">
            ...
            {#if !$isConnected}
              <Card class="bg-linear-to-r from-orange-500/10 to-accent/10 border-orange-500/20">
                <CardContent class="p-6 text-center">
                  ...
                  <h3 class="text-lg font-semibold text-foreground mb-2">Connect Your Wallet</h3>
              ...
              <div>
                ...
                <div class="space-y-4">
                  ...
                  <div class="surface-1 rounded-lg p-4">
                    ...
                    <ol class="text-foreground/80 text-sm space-y-2 ml-4 list-decimal">
                  ...
                  <div class="surface-1 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                      <div class="bg-primary/10 p-3 rounded">
                        ...
                        <div class="text-foreground/80">Base STC per view based on content type and engagement</div>
                      </div>
                      <div class="bg-secondary/10 p-3 rounded">
                        <div class="font-medium text-secondary mb-1">Premium Bonuses</div>
                        <div class="text-foreground/80">Extra STC for high-quality, educational content</div>
                      </div>
                      <div class="bg-accent/10 p-3 rounded">
                        <div class="font-medium text-accent mb-1">Completion Rewards</div>
                        <div class="text-foreground/80">Bonus STC when viewers complete your content</div>
                      </div>
                      <div class="bg-green-500/10 p-3 rounded">
                        <div class="font-medium text-green-400 mb-1">Staking Benefits</div>
                        <div class="text-foreground/80">Higher revenue share with more STC staked</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="surface-1 rounded-lg p-4">
                    ...
                    <div class="space-y-3">
                      <div class="border-l-4 border-red-500 pl-3">
                        ...
                        <ul class="text-foreground/80 text-xs space-y-1 mt-1">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card class="bg-primary/10 border-primary/20">
                  <CardContent class="p-4 text-center">
                    ...
                    <h4 class="font-medium text-foreground mb-2">Manage STC</h4>
                ...
                <Card class="bg-secondary/10 border-secondary/20">
                  <CardContent class="p-4 text-center">
                    ...
                    <h4 class="font-medium text-foreground mb-2">Revenue Analytics</h4>
                ...
                <Card class="bg-accent/10 border-accent/20">
                  <CardContent class="p-4 text-center">
                    ...
                    <h4 class="font-medium text-foreground mb-2">Upgrade Tier</h4>
              ...
              <Card class="bg-linear-to-r from-purple-500/10 to-blue-500/10 border-purple-500/20">
                ...
                <CardContent>
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div>
                      <h4 class="font-medium text-foreground mb-2">Documentation</h4>
                      <ul class="space-y-1 text-muted-foreground">
                        <li><a href="/docs/tokenomics" class="hover:text-foreground transition-colors">• Complete Tokenomics Guide</a></li>
                        <li><a href="/docs/staking" class="hover:text-foreground transition-colors">• Staking Tutorial</a></li>
                        <li><a href="/docs/wallet-setup" class="hover:text-foreground transition-colors">• Wallet Setup Guide</a></li>
                        <li><a href="/docs/creator-tiers" class="hover:text-foreground transition-colors">• Creator Tier Benefits</a></li>
                      </ul>
                    </div>
                    <div>
                      <h4 class="font-medium text-foreground mb-2">Community</h4>
                      <ul class="space-y-1 text-muted-foreground">
                        <li><a href="/discord" class="hover:text-foreground transition-colors">• Discord Community</a></li>
                        <li><a href="/forum/web3" class="hover:text-foreground transition-colors">• Web3 Discussion Forum</a></li>
                        <li><a href="/webinars" class="hover:text-foreground transition-colors">• Weekly Web3 Webinars</a></li>
                        <li><a href="/support/web3-office-hours" class="hover:text-foreground transition-colors">• Web3 Office Hours</a></li>
                      </ul>
                    </div>
                  </div>
                </CardContent>
        ...
        {:else if activeSection === 'technical'}
          <div class="space-y-6">
            <div>
              <h2 class="text-2xl font-bold text-foreground mb-4">Technical Issues</h2>
              <p class="text-foreground/80 mb-6">
            ...
            <div class="space-y-6">
              <div>
                <h3 class="text-xl font-bold text-foreground mb-4">Upload Issues</h3>
                <div class="space-y-3">
                  <div class="surface-1 rounded-lg p-4">
                    <h4 class="font-medium text-foreground mb-2">Video upload fails or gets stuck</h4>
                  ...
                  <div class="surface-1 rounded-lg p-4">
                    <h4 class="font-medium text-foreground mb-2">Poor video quality after upload</h4>
                    <ul class="text-foreground/80 text-sm space-y-1">
              ...
              <div>
                <h3 class="text-xl font-bold text-foreground mb-4">Audio Problems</h3>
                <div class="space-y-3">
                  <div class="surface-1 rounded-lg p-4">
                    <h4 class="font-medium text-foreground mb-2">Audio out of sync</h4>
                    <ul class="text-foreground/80 text-sm space-y-1">
                  ...
                  <div class="surface-1 rounded-lg p-4">
                    <h4 class="font-medium text-foreground mb-2">Low audio quality</h4>
                    <ul class="text-foreground/80 text-sm space-y-1">
              ...
              <div>
                <h3 class="text-xl font-bold text-foreground mb-4">Account & Access</h3>
                <div class="space-y-3">
                  <div class="surface-1 rounded-lg p-4">
                    <h4 class="font-medium text-foreground mb-2">Can't access creator dashboard</h4>
                    <ul class="text-foreground/80 text-sm space-y-1">
        ...
        {:else if activeSection === 'content'}
          <div class="space-y-6">
            <div>
              <h2 class="text-2xl font-bold text-foreground mb-4">Content Guidelines Help</h2>
              <p class="text-foreground/80 mb-6">
            ...
            <div class="space-y-4">
              <div class="bg-green-600/20 border border-green-600 rounded-lg p-4">
                <h3 class="text-lg font-bold text-foreground mb-3">✅ Content That Thrives</h3>
              ...
              <div class="bg-yellow-600/20 border border-yellow-600 rounded-lg p-4">
                <h3 class="text-lg font-bold text-foreground mb-3">⚠️ Content Under Review</h3>
              ...
              <div class="bg-red-600/20 border border-red-600 rounded-lg p-4">
                <h3 class="text-lg font-bold text-foreground mb-3">❌ Content Not Allowed</h3>
            ...
            <div class="bg-blue-600/20 border border-blue-600 rounded-lg p-4">
              <h3 class="text-lg font-bold text-foreground mb-2">💡 Need Clarification?</h3>
              <p class="text-blue-200 mb-3">
        ...
        {:else if activeSection === 'monetization'}
          <div class="space-y-6">
            <div>
              <h2 class="text-2xl font-bold text-foreground mb-4">Monetization Support</h2>
              <p class="text-foreground/80 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="surface-1 rounded-lg p-6">
                ...
                <p class="text-foreground/80 mb-4">Get funding for your film and content projects.</p>
                <ul class="space-y-2 text-foreground/80 text-sm mb-4">
              ...
              <div class="surface-1 rounded-lg p-6">
                ...
                <p class="text-foreground/80 mb-4">Allow viewers to support your ministry directly.</p>
                <ul class="space-y-2 text-foreground/80 text-sm mb-4">
            ...
            <div class="bg-purple-600/20 border border-purple-600 rounded-lg p-4">
              <h3 class="text-lg font-bold text-foreground mb-2">📈 Revenue Requirements</h3>
        ...
        {:else if activeSection === 'contact'}
          <div class="space-y-6">
            <div>
              <h2 class="text-2xl font-bold text-foreground mb-4">Contact Support</h2>
              <p class="text-foreground/80 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="surface-1 rounded-lg p-6">
                <h3 class="text-lg font-bold text-foreground mb-4">📧 Email Support</h3>
                <p class="text-foreground/80 mb-4">For non-urgent questions and detailed support requests.</p>
                <p class="text-purple-400 font-medium mb-2">support@sepharstudios.com</p>
                <p class="text-muted-foreground text-sm">Response time: 4-8 hours</p>
              </div>

              <div class="surface-1 rounded-lg p-6">
                <h3 class="text-lg font-bold text-foreground mb-4">💬 Live Chat</h3>
                <p class="text-foreground/80 mb-4">Real-time support during business hours.</p>
                <button class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium">
                  Start Chat
                </button>
                <p class="text-muted-foreground text-sm mt-2">Available Mon-Fri 9AM-6PM EST</p>
              </div>
            </div>

            <div class="surface-1 rounded-lg p-6">
              <h3 class="text-lg font-bold text-foreground mb-4">🎫 Submit Support Ticket</h3>
              <p class="text-foreground/80 mb-4">For technical issues or complex problems that need detailed attention.</p>
            ...
            <div class="bg-yellow-600/20 border border-yellow-600 rounded-lg p-4">
              <h3 class="text-lg font-bold text-foreground mb-2">🚨 Emergency Support</h3>
