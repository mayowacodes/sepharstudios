<script lang="ts">
  ...
  import { LogOut, Settings, User, Crown, Coins, Wallet } from '@lucide/svelte';
...
<DropdownMenu>
  ...
  <DropdownMenuContent class="w-56" align="end">
    ...
    <DropdownMenuItem>
      <a href="/subscription" class="flex items-center gap-2 w-full">
    ...
    <DropdownMenuItem>
      <a href="/tokens" class="flex items-center gap-2 w-full">
    ...
    <DropdownMenuItem>
      <a href="/plans" class="flex items-center gap-2 w-full">
